  ...
  const events = [
    {
      ...
      attendees: '60000+ expected in 2 days',
      description: 'Diwali Special Exhibition. A magnificent celebration of traditional arts, crafts, and cultural heritage featuring artisans from across India.',
      highlights: ['Fashion','Home Made','Home Decor','Traditional Crafts', 'Cultural Performances', 'Food Festival', 'Art'],
    },
    {
      title: 'Aangan The Grand Exhibition (Upcoming)',
      date: 'October 31 - November 01, 2026',
      time: '10:00 AM - 10:00 PM',
