...
const Reviews = () => {
  const customerGridRef = useScrollReveal<HTMLDivElement>({ selector: '.reveal-item', stagger: 0.06 });
  const stallholderGridRef = useScrollReveal<HTMLDivElement>({ selector: '.reveal-item', stagger: 0.06 });
    ...
    <section className="py-16 px-4 bg-muted/30">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-16">
          ...
          <div ref={customerGridRef} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <div ref={stallholderGridRef} className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4x4 mx-auto">
